                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                    $bookid = $_GET['id'];
                                    $sql = "select * from epiz_27044883_LMS.book where Bookid='$bookid'";
...
$sql1="update epiz_27044883_LMS.book set Title='$name', Publisher='$publisher', Year='$year', Availability='$avail' where BookId='$bookid'";
